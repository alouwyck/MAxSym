...
- Folder "+MAxSym" contains the m-files and mex-files to run MAxSym with MATLAB R2013b (64bit).

- Folder "Examples" contains the scripts discussed in the manual.

- File "License.txt" gives the terms and conditions of the “New BSD license”, a certified open source license, under which it is allowed to redistribute MAxSym. 
  
MAxSym is free software for academic and research purposes only. Please contact A. Louwyck to use MAxSym for commercial purposes.
